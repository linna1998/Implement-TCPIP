...
rp :: LossyRouterPort(DEV $dev10, IN_MAC $addrDev10 , OUT_MAC $addrDev9, LOSS 1, DELAY 0.2 );

user_client::UserClient(DELAY 2, FILENAME client3_user_log.txt)
tcp_client::TCPClient(MY_ADDRESS 6, OTHER_ADDRESS 1, DELAY 2, FILENAME client3_tcp_log.txt);
ip_client::IPClient(MY_ADDRESS 6, OTHER_ADDRESS 1, FILENAME client3_ip_log.txt);
bc::BasicClassifier;
