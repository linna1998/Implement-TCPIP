...
rp :: LossyRouterPort(DEV $dev6, IN_MAC $addrDev6 , OUT_MAC $addrDev5, LOSS 1, DELAY 0.2 );

user_client::UserClient(DELAY 2, FILENAME client2_user_log.txt)
tcp_client::TCPClient(MY_ADDRESS 4, OTHER_ADDRESS 1, DELAY 2, FILENAME client2_tcp_log.txt);
ip_client::IPClient(MY_ADDRESS 4, OTHER_ADDRESS 1, FILENAME client2_ip_log.txt);
bc::BasicClassifier;
